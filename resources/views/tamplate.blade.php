...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{url('/dashboard')}}" class="brand-link">
      <img src="{{('asset/jpg/logo.png')}}"
           alt="Mirroring System"
           class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Mirroring System</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="" class="nav-link">
                  <i class="far fa-clock nav-icon"></i><span class="badge badge-info right">6</span>
                  <p>Ditunda</p>
                </a>
              </li>
              <li class="nav-item">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('/mirorform')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Mirror To</p>
                </a>
              </li>
          ...
          <li class="nav-header">Extra Menus</li>
          <li class="nav-item">
